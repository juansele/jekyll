...
templates['inicio'] = '''
		...
		<style type="text/css">
			...
			.mett__mod-nota-legal{background:#EEE; padding: 1em 2em;font-size:13px;}
			.mett__banner-at-home{background:#EB6209; height: 80px; color: rgba(255,255,255,0.8);}
			.mett__text-center{text-align: center;}
		</style>
'''
...
templates['cabecera'] = '''
		...
		<div class="mett__contenedor-ficha">
			...
			<!-- BANNER LENOVO AT HOME -->
			<div class="mett__layout-row mett__justify-space-between mett__layout-wrap mett__banner-at-home">

				<div class="mett__flex-lg-10 mett__flex-md-10 mett__flex-sm-10 mett__flex-xs-10">


					<img src="../img/OTROS/logo_lenovo_at_home.svg" style="width:70px; height: 80px;">

				</div>

				<div class="mett__flex-lg-60 mett__flex-md-60 mett__flex-sm-60 mett__flex-xs-50 mett__layout-row mett__align-center mett__justify-center mett__layout-wrap">

					<div class="mett__flex-lg-100 mett__flex-md-100 mett__flex-sm-100 mett__flex-xs-100 mett__text-center">

						<b>RECOGEMOS TU EQUIPO, LO REPARAMOS Y TE LO DEVOLVEMOS</b>

						<p style="margin:0; font-size:13px;margin-top:0.3em;">SERVICIO TÉCNICO GRATÍS POR UN AÑO</p>

					</div>

				</div>

				<div class="mett__flex-lg-30 mett__flex-md-30 mett__flex-sm-30 mett__flex-xs-35 mett__layout-row mett__justify-end mett__align-center">
				
					<div class="mett__layout-row" style="width:95%; background:rgba(255,255,255,0.9);padding:0.5em;border-radius:3px;-webkit-border-radius:3px;margin-right:5px;">
					
						<div class="mett__flex-lg-20 mett__flex-md-20 mett__flex-sm-20 mett__flex-xs-20 mett__layout-row mett__justify-center mett__align-center">
						
							<div>
							
								<img src="../img/OTROS/phone.svg" style="width:25px;height:28px;">
								
							</div>
							
						</div>
						
						<div class="mett__flex-lg-80 mett__flex-md-80 mett__flex-sm-80 mett__flex-xs-80" style="padding:0em 0.5em;">
						
							<div style="color:#EB6209;font-size:13px;"><b>Llama ya</b></div>
							
							<div style="color:#EB6209;font-size:19px;">
					...
					<section class="mett__layout-row mett__layout-wrap mett__align-start">
						...
						<div class="mett__flex-lg-100 mett__flex-md-100 mett__flex-sm-100 mett__flex-xs-100 mett__flex-gt-100 mett__layout-row mett__layout-wrap mett__justify-space-between">
							...
							<div class="mett__flex-lg-10 mett__flex-md-15 mett__flex-sm-15 mett__flex-xs-10 mett__flex-gt-10 mett__layout-row mett__layout-wrap mett__justify-end" style="position: absolute;right:0px;">
								<div><img class="mett__logo" style="width:65.9px !important;height:196.4px !important;" src="${logo_lenovo}"></div>
							</div>
						</div>
					</section>
'''
...
templates['P'] = '''
					...
					<section class="mett__flex-lg-100 mett__flex-md-100 mett__flex-sm-100 mett__flex-xs-100 mett__flex-gt-100 mett__layout-row mett__justify-center mett__mod-section mett__layout-wrap" style="margin:3em 0em;">
...
templates['P-P'] = '''
					...
					<section class="mett__mod-section mett__layout-row mett__layout-wrap mett__justify-space-around mett__align-start" style="margin: 2em 0em;">
