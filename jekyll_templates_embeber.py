		...
		<div class="mett__contenedor-ficha">
			...
			<div class="mett__layout-row mett__justify-space-between mett__layout-wrap mett__banner-at-home">
				...
				<div class="mett__flex-lg-10 mett__flex-md-10 mett__flex-sm-10 mett__flex-xs-10">
					...
					<img src="../img/OTROS/logo_lenovo_at_home.svg" style="width:70px">

				</div>

				<div class="mett__flex-lg-60 mett__flex-md-60 mett__flex-sm-60 mett__flex-xs-60 mett__layout-row mett__align-center mett__justify-center mett__layout-wrap">
				...
				<div class="mett__flex-lg-30 mett__flex-md-30 mett__flex-sm-30 mett__flex-xs-30 mett__layout-row mett__justify-center mett__align-center">
				
					<div class="mett__layout-row" style="width:95%; background:rgba(255,255,255,0.9);padding:0.5em;border-radius:3px;-webkit-border-radius:3px;">
						...
						<div class="mett__flex-lg-20 mett__flex-md-20 mett__flex-sm-20 mett__flex-xs-20 mett__layout-row mett__justify-center mett__align-center">
							...
							<div>
								...
								<img src="../img/OTROS/phone.svg" style="width:30px;">
						...
						<div class="mett__flex-lg-80 mett__flex-md-80 mett__flex-sm-80 mett__flex-xs-80" style="padding:0em 0.5em;">
							...
							<div style="color:#EB6209;font-size:16px;">Llama ya</div>
							
							<div style="color:#EB6209;font-size:24px;">
