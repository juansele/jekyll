...
templates['inicio'] = '''
		...
		<style type="text/css">
			...
			.mett__note{font-size: 13px; color: rgba(0,0,0,0.8)}
		</style>
'''
...
templates['P'] = '''
					...
					<section class="mett__flex-lg-100 mett__flex-md-100 mett__flex-sm-100 mett__flex-xs-100 mett__flex-gt-100 mett__layout-row mett__justify-center mett__mod-section mett__layout-wrap" style="margin:3em 0em;">
						...
						<div class="mett__flex-lg-70 mett__flex-sm-80 mett__flex-xs-80 mett__flex-gt-90" style="margin-top: 1em;">
							<p class="mett__note">
								<b>Nota: Para verificar las caracrísticas exactas del equipo, recomendamos ver las especificaciones técnicas publicadas en esta página. </b>
							</p>
						</div>
					</section>
