...
(function(global, factory) {
    ...
    $.fn.fullpage = function(options) {
        //only once my friend!
        if($('#mett__container-to-embed-html').hasClass(ENABLED)){ displayWarnings(); return };

        // common jQuery objects
        var $htmlBody = $('#mett__container-to-embed-html, #mett__container-body');
        var $body = $('#mett__container-body');
        ...
        */
        ...
        FP.reBuild = function(resizing){
            ...
            windowsHeight = 650;  //updating global var
